...
def interSecureModelNetwork():
    data_input = 'mn_pv_1_2_bess_red.json'
    ...
    for host in data['hosts']:
        ...
        ip = host['ip']
        mac = host['mac']
        h = net.addHost(  name, cls=Host, ip=ip, defaultRoute='10.0.0.1',mac=f'00:00:00:00:00:{mac}')  
        host.update({'instance':h})

    # net.addHost(  'PPC',   cls=Host, ip='10.10.0.4/16', defaultRoute='10.0.0.1',mac='00:00:00:00:00:04')  # PPC
    # net.addHost(  'POI',   cls=Host, ip='10.10.0.5/16', defaultRoute='10.0.0.1',mac='00:00:00:00:00:05')  # POI
    ...
    net.addLink(  net.get( 'POI'), net.get( 'sPOI'))
    net.addLink(  net.get( 'PPC'), net.get( 'sPOI') )
